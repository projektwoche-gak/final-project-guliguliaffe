...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///workspaces/final-project-guliguliaffe/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///workspaces/final-project-guliguliaffe/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///workspaces/final-project-guliguliaffe/node_modules/devalue/index.js';
import destr from 'file:///workspaces/final-project-guliguliaffe/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///workspaces/final-project-guliguliaffe/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///workspaces/final-project-guliguliaffe/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///workspaces/final-project-guliguliaffe/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///workspaces/final-project-guliguliaffe/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///workspaces/final-project-guliguliaffe/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///workspaces/final-project-guliguliaffe/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///workspaces/final-project-guliguliaffe/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///workspaces/final-project-guliguliaffe/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///workspaces/final-project-guliguliaffe/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///workspaces/final-project-guliguliaffe/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///workspaces/final-project-guliguliaffe/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///workspaces/final-project-guliguliaffe/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///workspaces/final-project-guliguliaffe/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///workspaces/final-project-guliguliaffe/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///workspaces/final-project-guliguliaffe/node_modules/unctx/dist/index.mjs';
import { isVNode, version, unref } from 'file:///workspaces/final-project-guliguliaffe/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///workspaces/final-project-guliguliaffe/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///workspaces/final-project-guliguliaffe/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/workspaces/final-project-guliguliaffe/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspaces/final-project-guliguliaffe","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/workspaces/final-project-guliguliaffe/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspaces/final-project-guliguliaffe/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/workspaces/final-project-guliguliaffe/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/workspaces/final-project-guliguliaffe/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _A5GDDnkgFR = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/workspaces/final-project-guliguliaffe";
...
const _lazy_b8HRdM = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_b8HRdM, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_b8HRdM, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///workspaces/final-project-guliguliaffe/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///workspaces/final-project-guliguliaffe/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
